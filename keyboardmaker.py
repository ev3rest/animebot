...
async def normalkeyboard(post_id, container_index):
	...
	row_btns = (InlineKeyboardButton(text, callback_data=callback_cb.new(function=CallbackCommands.NEXT, container_index=container_index, value = data)) for text, data in text_and_data)
